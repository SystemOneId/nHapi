...
public class AL1 : AbstractSegment  {
   ...
   */
	...
	///<summary>
	/// Returns a single repetition of Allergen Code/Mnemonic/Description(AL1-3).
  ...
  ///<summary>
  /// Returns all repetitions of Allergen Code/Mnemonic/Description (AL1-3).
   ///</summary>
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Allergen Code/Mnemonic/Description (AL1-3).
   ///</summary>
