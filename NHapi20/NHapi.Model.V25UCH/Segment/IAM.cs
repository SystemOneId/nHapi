...
public class IAM : AbstractSegment  {
   ...
   */
    ...
    try {
       ...
       this.add(typeof(CE), true, 0, 250, new System.Object[]{message}, "Allergen Code/Mnemonic/Description");
	...
	///<summary>
	/// Returns a single repetition of Allergen Code/Mnemonic/Description(IAM-3).
	/// throws HL7Exception if the repetition number is invalid.
	/// <param name="rep">The repetition number (this is a repeating field)</param>
	///</summary>
	public CE GetAllergenCodeMnemonicDescription(int rep)
	{
			CE ret = null;
			try
			{
  ...
  ///<summary>
  /// Returns all repetitions of Allergen Code/Mnemonic/Description (IAM-3).
   ///</summary>
 ...
 return ret;
  ...
  ///<summary>
  /// Returns the total repetitions of Allergen Code/Mnemonic/Description (IAM-3).
   ///</summary>
  public int AllergenCodeMnemonicDescriptionRepetitionsUsed
{
get{
    try {
