...
{
///<summary>
///Represents the ADT_A01_PATIENT Group.  A Group is an ordered collection of message 
/// segments that can repeat together or be optionally in/excluded together.
/// This Group contains the following elements: 
///<ol>
///<li>0: PID (Patient Identification) </li>
///<li>1: ZPD (ZPD) optional </li>
...
///<li>11: ZIF (Infections) optional </li>
///</ol>
///</summary>
[Serializable]
public class ADT_A01_PATIENT : AbstractGroup {

	///<summary> 
	/// Creates a new ADT_A01_PATIENT Group.
	///</summary>
	public ADT_A01_PATIENT(IGroup parent, IModelClassFactory factory) : base(parent, factory){
	   try {
	      this.add(typeof(PID), true, false);
	      this.add(typeof(ZPD), false, false);
	      ...
	      this.add(typeof(ZIF), false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error creating ADT_A01_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
...
get{
	...
	///<summary>
	/// Returns ZPD (ZPD) - creates it if necessary
	///</summary>
	public ZPD ZPD { 
get{
	   ZPD ret = null;
	   try {
	      ret = (ZPD)this.GetStructure("ZPD");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
...
get{
	...
	///<summary>
	/// Returns ZIF (Infections) - creates it if necessary
	///</summary>
	public ZIF ZIF { 
get{
	   ZIF ret = null;
	   try {
	      ret = (ZIF)this.GetStructure("ZIF");
	   } catch(HL7Exception e) {
	      HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new System.Exception("An unexpected error ocurred",e);
	   }
